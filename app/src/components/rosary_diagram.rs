    ...
    view! {
        <div class="rosary-wrap">
            <svg class="rosary" viewBox="0 0 520 420" role="img" aria-labelledby="rosary-title rosary-desc">
                ...
                <circle cx="260" cy="285" r="7" class="large-bead our-father-bead"/>
                <circle cx="260" cy="315" r="4" class="bead"/><circle cx="260" cy="330" r="4" class="bead"/><circle cx="260" cy="345" r="4" class="bead"/>
                <circle cx="260" cy="363" r="7" class="large-bead our-father-bead"/>
